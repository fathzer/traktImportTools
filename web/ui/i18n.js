...
const TRANSLATIONS = {
    ...
    en: {
        ...
        btnDownloadTooltip: "Export complete state (successes and failures) with all corrections. The file can be re-imported to resume synchronization from the current state.",
        btnRetrySync: "🔄 Retry",
        btnRetryTooltip: "Retry synchronization of failed episodes. All errors, except those marked as 'Ignore' or 'inconsistent', will be retried. In particular, episodes marked 'Unknown to Trakt' will be retried as Trakt regularly updates its database.",
