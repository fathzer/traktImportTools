...
const TRANSLATIONS = {
    fr: {
        ...
        btnDownloadTooltip: "Exporte l'état complet (succès et échecs) avec toutes les corrections. Le fichier peut être réimporté pour reprendre la synchronisation à l'état actuel.",
        btnRetrySync: "🔄 Retenter",
        btnRetryTooltip: "Relance la synchronisation des épisodes en erreur. Toutes les erreurs, exceptées celles marquées comme 'Ignorer' ou 'incohérentes', seront retentées. En particulier, les épisodes marqués 'Inconnu Trakt' seront retentés car Trakt met régulièrement ses bases de données à jour.",
        ...
        // IMDB Helper
        btnImdbHelper: "🔍 Aide IMDb",
        btnImdbHelperTooltip: "Recherche les identifiants IMDb via l'API Trakt",
        imdbHelperTitle: "Recherche d'identifiants IMDb",
        imdbHelperClose: "Fermer",
        imdbHelperSearch: "Recherche",
        confidenceShowNotFound: "Série introuvable",
        confidenceSeasonNotFound: "Saison introuvable",
    ...
    en: {
        ...
        btnDownloadTooltip: "Exports complete state (successes and failures) with all corrections. The file can be re-imported to resume synchronization from the current state.",
        btnRetrySync: "🔄 Retry",
        btnRetryTooltip: "Retries synchronization of failed episodes. All errors, except those marked as 'Ignore' or 'inconsistent', will be retried. In particular, episodes marked 'Unknown to Trakt' will be retried as Trakt regularly updates its database.",
        ...
        // IMDB Helper
        btnImdbHelper: "🔍 IMDb Helper",
        btnImdbHelperTooltip: "Searches IMDb IDs via Trakt API",
        imdbHelperTitle: "IMDb ID Search",
        imdbHelperClose: "Close",
        imdbHelperSearch: "Search",
        confidenceShowNotFound: "Show not found",
        confidenceSeasonNotFound: "Season not found",
        confidenceHigh: "High",
